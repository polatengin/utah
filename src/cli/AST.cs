...
public record FsMoveFileExpression(Expression SourcePath, Expression TargetPath) : Expression;
...
public record FsMoveFileStatement(Expression SourcePath, Expression TargetPath) : Statement;
