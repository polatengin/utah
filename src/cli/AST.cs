...
public record ArrayMapExpression(Expression Array, LambdaExpression Callback) : Expression;
public record ArrayFilterExpression(Expression Array, LambdaExpression Callback) : Expression;
public record ArrayReduceExpression(Expression Array, LambdaExpression Callback, Expression? InitialValue) : Expression;
public record ArrayFindExpression(Expression Array, LambdaExpression Callback) : Expression;
public record ArraySomeExpression(Expression Array, LambdaExpression Callback) : Expression;
public record ArrayEveryExpression(Expression Array, LambdaExpression Callback) : Expression;
...
public record ProcessKillExpression(Expression Pid, Expression? Signal) : Expression;
...
public record FsWatchExpression(Expression Path, Expression Callback, Expression? Options = null) : Expression;
...
public record GitCurrentBranchExpression() : Expression;
public record GitIsCleanExpression() : Expression;
public record GitResetToCommitExpression(Expression CommitHash) : Expression;
public record DockerRunExpression(Expression Image, Expression? Name, Expression? Ports, Expression? Volumes) : Expression;
public record DockerStopExpression(Expression Container) : Expression;
public record DockerRemoveExpression(Expression Container) : Expression;
public record DockerRestartExpression(Expression Container) : Expression;
public record DockerLogsExpression(Expression Container) : Expression;
public record DockerExecExpression(Expression Container, Expression Command) : Expression;
public record DockerIsRunningExpression(Expression Container) : Expression;
public record DockerListExpression() : Expression;
public record DockerBuildExpression(Expression Tag, Expression? Path) : Expression;
public record DockerPullExpression(Expression Image) : Expression;
public record DockerPushExpression(Expression Image) : Expression;
public record DockerRemoveImageExpression(Expression Image) : Expression;
public record DockerImageExistsExpression(Expression Image) : Expression;
public record K8sGetContextExpression() : Expression;
public record K8sSetContextExpression(Expression Name) : Expression;
public record K8sGetNamespaceExpression() : Expression;
public record K8sSetNamespaceExpression(Expression Name) : Expression;
public record K8sClientVersionExpression() : Expression;
public record K8sServerVersionExpression() : Expression;
public record K8sGetExpression(Expression Resource, Expression? Name, Expression? Namespace) : Expression;
public record K8sDescribeExpression(Expression Resource, Expression Name, Expression? Namespace) : Expression;
public record K8sExistsExpression(Expression Resource, Expression Name, Expression? Namespace) : Expression;
public record K8sLogsExpression(Expression Pod, Expression? Container, Expression? Tail, Expression? Previous) : Expression;
public record K8sExecExpression(Expression Pod, Expression Command, Expression? Container) : Expression;
public record K8sPortForwardExpression(Expression Pod, Expression LocalPort, Expression RemotePort) : Expression;
public record K8sIsReadyExpression(Expression Pod, Expression? Namespace) : Expression;
public record K8sScaleExpression(Expression Resource, Expression Name, Expression Replicas) : Expression;
public record K8sGetSecretExpression(Expression Name, Expression? Key, Expression? Namespace) : Expression;
public record K8sSetSecretExpression(Expression Name, Expression Key, Expression Value) : Expression;
public record K8sTopPodsExpression(Expression? Namespace) : Expression;
public record K8sTopNodesExpression() : Expression;
