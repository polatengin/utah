...
if [ $(eval "echo \${${asyncConn}[connected]}") ]; then
  result=$({ conn_var=${asyncConn}; if [ "$(eval "echo \${${asyncConn}[async]}")" = "true" ]; then;   # Use control master for async connection;   ssh_cmd="ssh -S $(eval "echo \${${asyncConn}[socket]}")";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     ssh_cmd="$ssh_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     ssh_cmd="sshpass -e $ssh_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $ssh_cmd "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")" -p "$(eval "echo \${${asyncConn}[port]}")" "echo 'Hello from remote'"; else;   # One-time connection;   ssh_cmd="ssh";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     ssh_cmd="$ssh_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     ssh_cmd="sshpass -e $ssh_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $ssh_cmd "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")" -p "$(eval "echo \${${asyncConn}[port]}")" "echo 'Hello from remote'"; fi })
  echo "Execute result: ${result}"
  dirList=$({ conn_var=${asyncConn}; if [ "$(eval "echo \${${asyncConn}[async]}")" = "true" ]; then;   # Use control master for async connection;   ssh_cmd="ssh -S $(eval "echo \${${asyncConn}[socket]}")";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     ssh_cmd="$ssh_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     ssh_cmd="sshpass -e $ssh_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $ssh_cmd "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")" -p "$(eval "echo \${${asyncConn}[port]}")" "ls -la /tmp"; else;   # One-time connection;   ssh_cmd="ssh";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     ssh_cmd="$ssh_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     ssh_cmd="sshpass -e $ssh_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $ssh_cmd "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")" -p "$(eval "echo \${${asyncConn}[port]}")" "ls -la /tmp"; fi })
  echo "Directory listing completed"
fi
if [ $(eval "echo \${${asyncConn}[connected]}") ]; then
  testContent="Hello World from Utah!"
  echo ${testContent} > "/tmp/test_upload.txt"
  uploadSuccess=$({ conn_var=${asyncConn}; if [ "$(eval "echo \${${asyncConn}[async]}")" = "true" ]; then;   # Use control master for async connection;   scp_cmd="scp -o ControlPath=$(eval "echo \${${asyncConn}[socket]}")";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     scp_cmd="$scp_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     scp_cmd="sshpass -e $scp_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $scp_cmd -P "$(eval "echo \${${asyncConn}[port]}")" "/tmp/test_upload.txt" "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")":"/tmp/remote_test.txt";   upload_result=$?; else;   # One-time connection;   scp_cmd="scp";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     scp_cmd="$scp_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     scp_cmd="sshpass -e $scp_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $scp_cmd -P "$(eval "echo \${${asyncConn}[port]}")" "/tmp/test_upload.txt" "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")":"/tmp/remote_test.txt";   upload_result=$?; fi; if [ $upload_result -eq 0 ]; then echo "true"; else echo "false"; fi })
  echo "Upload result: ${uploadSuccess}"
  if [ "${uploadSuccess}" = "true" ]; then
    remoteContent=$({ conn_var=${asyncConn}; if [ "$(eval "echo \${${asyncConn}[async]}")" = "true" ]; then;   # Use control master for async connection;   ssh_cmd="ssh -S $(eval "echo \${${asyncConn}[socket]}")";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     ssh_cmd="$ssh_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     ssh_cmd="sshpass -e $ssh_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $ssh_cmd "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")" -p "$(eval "echo \${${asyncConn}[port]}")" "cat /tmp/remote_test.txt"; else;   # One-time connection;   ssh_cmd="ssh";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     ssh_cmd="$ssh_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     ssh_cmd="sshpass -e $ssh_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $ssh_cmd "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")" -p "$(eval "echo \${${asyncConn}[port]}")" "cat /tmp/remote_test.txt"; fi })
    echo "Remote file content: ${remoteContent}"
  fi
fi
if [ $(eval "echo \${${asyncConn}[connected]}") ]; then
  createResult=$({ conn_var=${asyncConn}; if [ "$(eval "echo \${${asyncConn}[async]}")" = "true" ]; then;   # Use control master for async connection;   ssh_cmd="ssh -S $(eval "echo \${${asyncConn}[socket]}")";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     ssh_cmd="$ssh_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     ssh_cmd="sshpass -e $ssh_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $ssh_cmd "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")" -p "$(eval "echo \${${asyncConn}[port]}")" "echo 'Download test content' > /tmp/remote_download.txt"; else;   # One-time connection;   ssh_cmd="ssh";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     ssh_cmd="$ssh_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     ssh_cmd="sshpass -e $ssh_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $ssh_cmd "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")" -p "$(eval "echo \${${asyncConn}[port]}")" "echo 'Download test content' > /tmp/remote_download.txt"; fi })
  downloadSuccess=$({ conn_var=${asyncConn}; if [ "$(eval "echo \${${asyncConn}[async]}")" = "true" ]; then;   # Use control master for async connection;   scp_cmd="scp -o ControlPath=$(eval "echo \${${asyncConn}[socket]}")";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     scp_cmd="$scp_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     scp_cmd="sshpass -e $scp_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $scp_cmd -P "$(eval "echo \${${asyncConn}[port]}")" "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")":"/tmp/remote_download.txt" "/tmp/local_download.txt";   download_result=$?; else;   # One-time connection;   scp_cmd="scp";   if [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "key" ]; then;     scp_cmd="$scp_cmd -i $(eval "echo \${${asyncConn}[keyPath]}")";   elif [ "$(eval "echo \${${asyncConn}[authMethod]}")" = "password" ]; then;     scp_cmd="sshpass -e $scp_cmd";   fi;   SSHPASS="$(eval "echo \${${asyncConn}[password]}")" $scp_cmd -P "$(eval "echo \${${asyncConn}[port]}")" "$(eval "echo \${${asyncConn}[username]}")@$(eval "echo \${${asyncConn}[host]}")":"/tmp/remote_download.txt" "/tmp/local_download.txt";   download_result=$?; fi; if [ $download_result -eq 0 ]; then echo "true"; else echo "false"; fi })
  echo "Download result: ${downloadSuccess}"
  if [ "${downloadSuccess}" = "true" ]; then
    localExists=$([ -e "/tmp/local_download.txt" ] && echo "true" || echo "false")
    echo "Local file exists after download: ${localExists}"
  fi
fi
